...
function __input_config_verbs()
{
    return {
        keyboard_and_mouse:
        {
			...
			duck:   [input_binding_key(vk_down),     input_binding_key("S")],
            
			jump:   [input_binding_key(vk_space),    input_binding_key(vk_lshift),
				     input_binding_key(vk_rcontrol), input_binding_key(vk_rshift)
					 ],
        ...
        gamepad:
        {
			...
			duck:   [input_binding_gamepad_axis(gp_axislv, false), input_binding_gamepad_button(gp_padd),
				     input_binding_gamepad_button(gp_face2)],
            
			jump:    input_binding_gamepad_button(gp_face1),
			
            accept: [input_binding_gamepad_button(gp_face1), input_binding_gamepad_button(gp_face1)],
